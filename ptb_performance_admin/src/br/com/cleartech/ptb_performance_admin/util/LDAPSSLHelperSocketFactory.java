...
public class LDAPSSLHelperSocketFactory extends SSLSocketFactory {

	    private SSLSocketFactory socketFactory;
	    public LDAPSSLHelperSocketFactory() {
	        try {
	          SSLContext ctx = SSLContext.getInstance("TLS");
	          ctx.init(null, new TrustManager[]{ new LDAPSSLHelperTrustManager()}, new SecureRandom());
	          socketFactory = ctx.getSocketFactory();
	        } catch ( Exception ex ){ throw new IllegalArgumentException(ex); }
	    }

	      public static SocketFactory getDefault() { return new LDAPSSLHelperSocketFactory(); }
	...
	class LDAPSSLHelperTrustManager implements X509TrustManager {
