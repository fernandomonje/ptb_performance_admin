...
<title>Editar Dados de Prestadora - SPID[<%=carrier.getSpid()%>]
</title>
...
<body>
	...
	<form action="EditCarrier" method="POST"">
		SPID&nbsp;:&nbsp;<input type="text" value="<%=carrier.getSpid()%>"
			name="spid" size="10" disabled><br /> NOME&nbsp;:&nbsp;<input
			type="text" value="<%=carrier.getName()%>" name="name" size="30"><br />
		<%
		...
		STATUS&nbsp;:&nbsp;<input type="radio" name="status" value="true"
			checked="checked">&nbsp;ATIVA&nbsp;&nbsp;&nbsp;<input
			type="radio" name="status" value="false">&nbsp;INATIVA
		<%
			} else {
		%>
		STATUS&nbsp;:&nbsp;<input type="radio" name="status" value="true">&nbsp;ATIVA&nbsp;&nbsp;&nbsp;<input
			type="radio" name="status" value="false" checked="checked">&nbsp;INATIVA
		<%
			}
			;
		%>
