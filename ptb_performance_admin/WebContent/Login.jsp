...
<form action="Login" method="POST" class="form-signin">
      ...
      <input type="text" id="username" name="username"class="form-control" placeholder="Usuario de Rede" required autofocus>
    ...
    <%if(messages != null) { %>
		...
		<div class="alert alert-danger" role="alert">
			...
			<% if (messages.get("password") != null) { %>
				<%=messages.get("password")%> <br />
			<% } %>
			<% if (messages.get("login") != null) { %>
				<%=messages.get("login")%> <br />
			<% } %>	
  		</div>
	<% } %>
