...
%>
  ...
  <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Detalhes de Prestadora - SPID[<%=carrier.getSpid()%>]</h5>
  		...
  		<div class="modal-footer">
    		<div class="panel-footer">
      			<input type="button" value="Editar" onclick="window.location='<%=request.getContextPath()%>/EditCarrier?spid=<%=carrier.getSpid()%>';">
